...
print(confusion_matrix(y_test, predictions))      # Shows your 4 prediction types. TP,TN,FP,FN
print(classification_report(y_test, predictions))  # Shows the % how well it perforemd by generating precision recall table.


# Macro avg ignores the classes for e.g precision and recall adds both like they are equal and divides by 2.
# Weighted avg takes into account the classes and the weighted support so it will multiply:
# (44 * 0.95 + 56 * 0.95) / 100 = 0.95 - Class 1 contributes more because it has 56 people.
