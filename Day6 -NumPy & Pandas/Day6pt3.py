...
df2 = pd.read_csv("../portfolio.csv")   # Goes into FullProgram and searches for portfolio.csv converts it to Dataframe
print(df2)
print(df2.describe())
...
df2["value"] = (df2["price"] * df2["quantity"]).round(2)  # adds 'value' row
...
print("Report Saved!")  # in line 15 .to_csv means convert it to a csv
